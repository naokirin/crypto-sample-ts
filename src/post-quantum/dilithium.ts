...
export async function initDilithium(): Promise<void> {
  ...
  try {
    ...
    const wasmInit = (await import("../../wasm-src/dilithium-wasm/pkg/dilithium_wasm.js")).default;
    ...
    throw new Error(`Failed to initialize Dilithium WebAssembly module: ${error}`);
  }
}
