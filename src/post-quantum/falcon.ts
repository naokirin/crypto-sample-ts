...
import type { FalconKeyPair } from "../../wasm-src/falcon-rust-wasm/pkg/falcon_rust_wasm.js";
 ...
 */
export async function verifyFalcon(
  message: Uint8Array,
  ...
  // wasmExportsから直接verify_signature関数を取得
